      ...
      >
        <div className="mx-auto mb-5 grid w-full max-w-xl gap-3 text-left sm:grid-cols-2">
          <label className="space-y-2">
            <span className="text-xs font-semibold tracking-wide text-emerald-100/80 uppercase">Crop</span>
            <input
              type="text"
              value={crop}
            ...
            />
            <p className="text-xs text-emerald-50/55">Type the fruit name directly.</p>
          </label>
          <label className="space-y-2">
            <span className="text-xs font-semibold tracking-wide text-emerald-100/80 uppercase">City (Optional)</span>
            <input
              type="text"
              value={city}
